 ...
 * Generated: 2026-03-07T07:56:56.110Z
 * Total: 1522 tickers across 12 categories
 *
...
export const ASSET_CLASSES: Record<string, AssetClassInfo> = {
  'Crypto': { maxLev: 3, minFeeBps: 4, label: 'Crypto' },
  ...
  'StakingDeriv': { maxLev: 5, minFeeBps: 3, label: 'Staking Derivative' },
}
...
export const TICKER_CATEGORIES: Record<string, string[]> = {
  'Crypto': [
    '0G', '1INCH', 'AAVE', 'ACT', 'ADA', 'AERO', 'AEVO', 'AI16Z', 'AIXBT', 'AKT', 'ALGO', 'ALICE',
    'ALT', 'ANIME', 'ANKR', 'APE', 'APEX', 'API3', 'APT', 'AR', 'ARB', 'ARKM', 'ASTR', 'ATH',
    'ATLAS', 'ATOM', 'AUDIO', 'AURORA', 'AVAIL', 'AVAX', 'AXL', 'AXS', 'BAL', 'BAND', 'BAT', 'BCH',
    'BEAM', 'BERA', 'BGB', 'BIO', 'BLAST', 'BLUR', 'BNB', 'BOBA', 'BTC', 'BTT', 'CAKE', 'CARV',
    'CELO', 'CELR', 'CETUS', 'CFX', 'CHR', 'CHZ', 'COMP', 'CORE', 'COW', 'CRO', 'CRV', 'CSPR',
    'CTSI', 'DEEP', 'DEXE', 'DODO', 'DOT', 'DRIFT', 'DYDX', 'DYM', 'EDU', 'EGLD', 'EIGEN', 'ELIZAOS',
    'ENA', 'ENJ', 'ENS', 'ETC', 'ETH', 'ETHFI', 'EUL', 'EVAA', 'FET', 'FIL', 'FLOW', 'FLR',
    'FLUID', 'FORM', 'FTT', 'FUEL', 'GALA', 'GLM', 'GLMR', 'GMT', 'GMX', 'GNO', 'GNS', 'GRASS',
    'GRT', 'GT', 'HBAR', 'HEMI', 'HFT', 'HNT', 'HOLO', 'HONEY', 'HT', 'HUMA', 'HYPE', 'HYPER',
    'ICP', 'ICX', 'ILV', 'IMX', 'INIT', 'INJ', 'IO', 'IOTA', 'IOTX', 'JASMY', 'JLP', 'JOE',
    'JTO', 'JUP', 'KAIA', 'KAITO', 'KAS', 'KAVA', 'KCS', 'KERNEL', 'KMNO', 'KNC', 'KSM', 'LAYER',
    'LDO', 'LEO', 'LINEA', 'LINK', 'LOOKS', 'LQTY', 'LRC', 'LST', 'LTC', 'MANA', 'MANTA', 'MASK',
    'MAV', 'ME', 'MERL', 'METIS', 'MINA', 'MNDE', 'MNT', 'MOBILE', 'MODE', 'MORPHO', 'MOVE', 'NAVX',
    'NEAR', 'NEON', 'NEXO', 'NTRN', 'ODOS', 'OKB', 'OM', 'ONDO', 'ONE', 'OP', 'ORCA', 'ORDER',
    'ORDI', 'OSMO', 'PARTI', 'PAXG', 'PENDLE', 'PERP', 'PLUME', 'POL', 'PRIME', 'PROMPT', 'PYTH', 'QNT',
    'QTUM', 'RAY', 'RDNT', 'RENDER', 'REZ', 'ROSE', 'RPL', 'RSR', 'RUNE', 'S', 'SAFE', 'SAND',
    'SCA', 'SCRT', 'SEDA', 'SEI', 'SHADOW', 'SIGN', 'SKL', 'SKY', 'SOL', 'SONIC', 'SPELL', 'STG',
    'STONE', 'STORJ', 'STRK', 'STX', 'SUI', 'SUSHI', 'SXP', 'SYN', 'SYRUP', 'TAIKO', 'TAO', 'THE',
    'THETA', 'TIA', 'TNSR', 'TON', 'TRB', 'TRX', 'TWT', 'UNI', 'VANA', 'VET', 'W', 'WLD',
    'WOO', 'XAI', 'XAUT', 'XDC', 'XEC', 'XION', 'XLM', 'XMR', 'XRP', 'XTZ', 'ZEC', 'ZEN',
    'ZETA', 'ZEUS', 'ZIL', 'ZK', 'ZRO',
  ],
  'US Equities': [
  ...
  'UK Equities': [
    'AAF', 'ABF', 'AHT', 'ALW', 'ANTO', 'AUTO', 'AV', 'BAB', 'BARC', 'BATS', 'BEZ', 'BKG',
    'BLND', 'BNZL', 'BP', 'BTA', 'BTRW', 'CCH', 'CNA', 'CPG', 'CRDA', 'CSPX', 'CTEC', 'DCC',
    'DGE', 'DPLM', 'EDV', 'ENT', 'EXPN', 'EZJ', 'FCIT', 'FRES', 'GAW', 'GLEN', 'GSK', 'HIK',
    'HLMA', 'HLN', 'HSBA', 'HSX', 'HWDN', 'IAG', 'IB01', 'IBTA', 'ICG', 'IHG', 'III', 'IMB',
    'IMI', 'INF', 'ISF', 'ITRK', 'KGF', 'LAND', 'LGEN', 'LLOY', 'LMP', 'LSEG', 'MKS', 'MNDI',
    'MNG', 'MRO', 'NG', 'NWG', 'NXT', 'PCT', 'PHNX', 'PSH', 'PSN', 'PSON', 'REL', 'RKT',
    'RMV', 'RTO', 'SBRY', 'SDR', 'SGE', 'SGRO', 'SHEL', 'SMT', 'SN', 'SPX', 'SSE', 'STAN',
    'STJ', 'SVT', 'TW', 'ULVR', 'UTG', 'UU', 'VOD', 'WEIR', 'WPP', 'WTB',
  ],
  'DE Equities': [
    'ADS', 'ALV', 'BAS', 'BAYN', 'BEI', 'BMW', 'BNR', 'CBK', 'CON', 'DB1', 'DBK', 'DHL',
    'DN3', 'DTG', 'ENR', 'EOAN', 'FME', 'FRE', 'HEI', 'HEN3', 'HNR1', 'IFX', 'MBG', 'MTX',
    'MUV2', 'P911', 'PAH3', 'RHM', 'RWE', 'SHL', 'SIE', 'SRT3', 'SY1', 'VNA', 'VOW3', 'ZAL',
  ],
  'FR Equities': [
    'AC', 'ACA', 'AM', 'BN', 'BNP', 'BVI', 'C3M', 'CA', 'CAP', 'CS', 'DSY', 'EDEN',
    'EN', 'ENGI', 'GLE', 'HO', 'KER', 'LR', 'MC', 'ML', 'OR', 'ORA', 'PUB', 'RI',
    'RMS', 'RNO', 'SAF', 'SAN', 'SGO', 'SU', 'TEP', 'TTE', 'URW', 'VIE',
  ],
  'NL Equities': [
    'AIR', 'BCOIN', 'QIA', 'STLAP', 'STMPA',
  ],
  'LU Equities': [
    'ERF', 'MT',
  ],
  ...
  'Staking Derivs': [
    'AFSUI', 'BBSOL', 'BNSOL', 'BSOL', 'CBBTC', 'CBETH', 'DSOL', 'EBTC', 'EZETH', 'HASUI', 'IBERA', 'IBGT',
    'JITOSOL', 'KBTC', 'KHYPE', 'LBGT', 'LBTC', 'LHYPE', 'MBTC', 'METH', 'MHYPE', 'MSETH', 'MSOL', 'RETH',
    'RSETH', 'RSWETH', 'SCETH', 'SOLVBTC', 'STETH', 'STHYPE', 'STSUI', 'SWETH', 'TBTC', 'UBTC', 'UETH', 'USOL',
    'VSUI', 'WBETH', 'WBTC', 'WEETH', 'WETH', 'WSTETH', 'XBTC', 'ZBTC',
  ],
}
...
/** All 1522 supported ticker symbols */
